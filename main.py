...
st.sidebar.image('Logo Klinik Gunuang.png', width=200, use_column_width=True)  # Gantilah URL dengan URL logo Anda
...
# pages = ["Dashboard", "Data Training", "Data Uji", "Hitung Jarak Euclidean", "Perangkingan", "Hasil Prediksi"]
